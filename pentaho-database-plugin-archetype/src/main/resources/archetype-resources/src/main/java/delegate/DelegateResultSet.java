...
public class DelegateResultSet implements ResultSet {
   ...
   * @see Statement${symbol_pound}setFetchDirection
   ...
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support
   *                                         this method
   * @see DatabaseMetaData${symbol_pound}updatesAreDetected
   * @since 1.2
   */
  @Override
   ...
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support
   *                                         this method
   * @see DatabaseMetaData${symbol_pound}insertsAreDetected
   * @since 1.2
   */
  @Override
   ...
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support
   *                                         this method
   * @see DatabaseMetaData${symbol_pound}deletesAreDetected
   * @since 1.2
   */
  @Override
