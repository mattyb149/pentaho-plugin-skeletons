...
public class DelegateCallableStatement implements CallableStatement {
  private final CallableStatement realCallableStatement;

  public DelegateCallableStatement( CallableStatement realCallableStatement ) {
   ...
   * {@link ${symbol_pound}getObject} retrieves the value.
   *
   ...
   *                                         this method
   * @see ${symbol_pound}setBigDecimal
   ...
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support
   *                                         this method
   * @see ${symbol_pound}getBigDecimal
   * @since 1.4
   */
  @Override
  ...
  public ResultSet executeQuery() throws SQLException {
    return new DelegateResultSet( realCallableStatement.executeQuery() );
  }
   ...
   *                             method has been exceeded and has at least attempted to cancel
   *                             the currently running {@code Statement}
   * @see Statement${symbol_pound}execute
   * @see Statement${symbol_pound}getResultSet
   * @see Statement${symbol_pound}getUpdateCount
   * @see Statement${symbol_pound}getMoreResults
   */
  @Override
   ...
   * @throws SQLException if a database access error occurs or
   *                      this method is called on a closed <code>PreparedStatement</code>
   * @see Statement${symbol_pound}addBatch
   * @since 1.2
   */
  @Override
  ...
  public ResultSetMetaData getMetaData() throws SQLException {
    return new DelegateResultSetMetaData( realCallableStatement.getMetaData() );
  }
  ...
  public ParameterMetaData getParameterMetaData() throws SQLException {
    return new DelegateParameterMetaData( realCallableStatement.getParameterMetaData() );
  }
  ...
  public ResultSet executeQuery( String sql ) throws SQLException {
    return new DelegateResultSet( realCallableStatement.executeQuery( sql ) );
  }
   ...
   * @see ${symbol_pound}setMaxFieldSize
   */
  @Override
   ...
   * @see ${symbol_pound}getMaxFieldSize
   */
  @Override
   ...
   * @throws SQLException if a database access error occurs or
   *                      this method is called on a closed <code>Statement</code>
   * @see ${symbol_pound}setQueryTimeout
   */
  @Override
   ...
   * @see ${symbol_pound}getQueryTimeout
   */
  @Override
   ...
   *                             method has been exceeded and has at least attempted to cancel
   *                             the currently running {@code Statement}
   * @see ${symbol_pound}getResultSet
   * @see ${symbol_pound}getUpdateCount
   * @see ${symbol_pound}getMoreResults
   */
  @Override
   ...
   * @throws SQLException if a database access error occurs or
   *                      this method is called on a closed <code>Statement</code>
   * @see ${symbol_pound}execute
   */
  @Override
  public ResultSet getResultSet() throws SQLException {
    return new DelegateResultSet( realCallableStatement.getResultSet() );
  }
   ...
   * @see ${symbol_pound}getFetchDirection
   * @since 1.2
   */
  @Override
   ...
   * @throws SQLException if a database access error occurs or
   *                      this method is called on a closed <code>Statement</code>
   * @see ${symbol_pound}setFetchDirection
   * @since 1.2
   */
  @Override
   ...
   *                      <code>PreparedStatement</code> or <code>CallableStatement</code>
   * @see ${symbol_pound}executeBatch
   * @see DatabaseMetaData${symbol_pound}supportsBatchUpdates
   * @since 1.2
   */
  @Override
  ...
  public Connection getConnection() throws SQLException {
    Connection connection = realCallableStatement.getConnection();
    return ( connection instanceof DelegateConnection ? connection : new DelegateConnection( connection ) );
  }
  ...
  public ResultSet getGeneratedKeys() throws SQLException {
    return new DelegateResultSet( realCallableStatement.getGeneratedKeys() );
  }
   ...
   * @see ${symbol_pound}getUpdateCount
   * @see ${symbol_pound}getMoreResults
   * @see ${symbol_pound}getGeneratedKeys
   * @since 1.4
   */
  @Override
   ...
   *                      <code>Statement</code>
   *                      <p/>
   * @see Statement${symbol_pound}setPoolable(boolean) setPoolable(boolean)
   * @since 1.6
   * <p/>
   */
  @Override
