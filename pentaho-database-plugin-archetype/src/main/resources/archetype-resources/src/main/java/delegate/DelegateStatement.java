...
public class DelegateStatement implements Statement {
  ...
  public DelegateStatement( Statement realStatement ) {
  ...
  public ResultSet executeQuery( String sql ) throws SQLException {
    return new DelegateResultSet( realStatement.executeQuery( sql ) );
  }
  ...
  public ResultSet getResultSet() throws SQLException {
    return new DelegateResultSet( realStatement.getResultSet() );
  }
  ...
  public ResultSet getGeneratedKeys() throws SQLException {
    return new DelegateResultSet( realStatement.getGeneratedKeys() );
  }
