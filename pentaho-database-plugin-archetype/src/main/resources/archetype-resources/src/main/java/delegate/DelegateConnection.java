...
public class DelegateConnection implements Connection {
  ...
  public DelegateConnection( Connection realConnection ) {
   ...
   * calling {@link ${symbol_pound}getHoldability}.
   *
  ...
  public Statement createStatement() throws SQLException {
    return new DelegateStatement( realConnection.createStatement() );
  }
  ...
  public PreparedStatement prepareStatement( String sql ) throws SQLException {
    return new DelegatePreparedStatement( realConnection.prepareStatement( sql ) );
  }
  ...
  public CallableStatement prepareCall( String sql ) throws SQLException {
    return new DelegateCallableStatement( realConnection.prepareCall( sql ) );
  }
   ...
   *                      or this method is called on a closed connection
   * @see ${symbol_pound}getAutoCommit
   */
  @Override
   ...
   * @throws SQLException if a database access error occurs
   *                      or this method is called on a closed connection
   * @see ${symbol_pound}setAutoCommit
   */
  @Override
  ...
  public DatabaseMetaData getMetaData() throws SQLException {
    return new DelegateDatabaseMetaData( realConnection.getMetaData() );
  }
   ...
   *                      constants
   * @see DatabaseMetaData${symbol_pound}supportsTransactionIsolationLevel
   * @see ${symbol_pound}getTransactionIsolation
   */
  @Override
   ...
   * @throws SQLException if a database access error occurs
   *                      or this method is called on a closed connection
   * @see ${symbol_pound}setTransactionIsolation
   */
  @Override
  ...
  public Statement createStatement( int resultSetType, int resultSetConcurrency ) throws SQLException {
    return new DelegateStatement( realConnection.createStatement( resultSetType, resultSetConcurrency ) );
  }
  ...
  public PreparedStatement prepareStatement( String sql, int resultSetType, int resultSetConcurrency ) throws SQLException {
    return new DelegatePreparedStatement(
      realConnection.prepareStatement( sql, resultSetType, resultSetConcurrency ) );
  }
  ...
  public CallableStatement prepareCall( String sql, int resultSetType, int resultSetConcurrency ) throws SQLException {
    return new DelegateCallableStatement(
      realConnection.prepareCall( sql, resultSetType, resultSetConcurrency ) );
  }
   ...
   * {@link DatabaseMetaData${symbol_pound}getResultSetHoldability}.
   *
   ...
   * @see ${symbol_pound}getHoldability
   * @see DatabaseMetaData${symbol_pound}getResultSetHoldability
   * @see ResultSet
   * @since 1.4
   */
  @Override
   ...
   * @throws SQLException if a database access error occurs
   *                      or this method is called on a closed connection
   * @see ${symbol_pound}setHoldability
   * @see DatabaseMetaData${symbol_pound}getResultSetHoldability
   * @see ResultSet
   * @since 1.4
   */
  ...
  public Statement createStatement( int resultSetType, int resultSetConcurrency, int resultSetHoldability ) throws SQLException {
    return new DelegateStatement(
      realConnection.createStatement( resultSetType, resultSetConcurrency, resultSetHoldability ) );
  }
  ...
  public PreparedStatement prepareStatement( String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability ) throws SQLException {
    return new DelegatePreparedStatement(
      realConnection.prepareStatement( sql, resultSetType, resultSetConcurrency, resultSetHoldability ) );
  }
  ...
  public CallableStatement prepareCall( String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability ) throws SQLException {
    return new DelegateCallableStatement(
      realConnection.prepareCall( sql, resultSetType, resultSetConcurrency, resultSetHoldability ) );
  }
  ...
  public PreparedStatement prepareStatement( String sql, int autoGeneratedKeys ) throws SQLException {
    return new DelegatePreparedStatement( realConnection.prepareStatement( sql, autoGeneratedKeys ) );
  }
  ...
  public PreparedStatement prepareStatement( String sql, int[] columnIndexes ) throws SQLException {
    return new DelegatePreparedStatement( realConnection.prepareStatement( sql, columnIndexes ) );
  }
  ...
  public PreparedStatement prepareStatement( String sql, String[] columnNames ) throws SQLException {
    return new DelegatePreparedStatement( realConnection.prepareStatement( sql, columnNames ) );
  }
   ...
   *                      is less then 0
   * @see DatabaseMetaData${symbol_pound}getClientInfoProperties
   * @since 1.6
   * <p/>
   */
  @Override
   ...
   *                                is called on a closed connection
   *                                <p/>
   * @see Connection${symbol_pound}setClientInfo(String, String) setClientInfo(String, String)
   * @since 1.6
   * <p/>
   */
  @Override
   ...
   *                           <code>checkPermission</code> method denies calling <code>abort</code>
   * @see SecurityManager${symbol_pound}checkPermission
   * @see Executor
   * @since 1.7
   */
  @Override
   ...
   * {@link ${symbol_pound}abort abort() } method which provides an administrator
   ...
   *                                         this method
   * @see SecurityManager${symbol_pound}checkPermission
   * @see Statement${symbol_pound}setQueryTimeout
   * @see ${symbol_pound}getNetworkTimeout
   * @see ${symbol_pound}abort
   * @see Executor
   * @since 1.7
   */
  @Override
   ...
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support
   *                                         this method
   * @see ${symbol_pound}setNetworkTimeout
   * @since 1.7
   */
  @Override
