...
public class DelegateDatabaseMetaData implements DatabaseMetaData {
  private final DatabaseMetaData realDatabaseMetaData;

  public DelegateDatabaseMetaData( DatabaseMetaData realDatabaseMetaData ) {
  ...
  public String getURL() throws SQLException {
    return realDatabaseMetaData.getURL();
  }
  ...
  public String getUserName() throws SQLException {
    return realDatabaseMetaData.getUserName();
  }
   ...
   * @throws SQLException if a database access error occurs
   * @see ${symbol_pound}getSearchStringEscape
   */
  @Override
  public ResultSet getProcedures( String catalog, String schemaPattern, String procedureNamePattern ) throws SQLException {
    return new DelegateResultSet(
      realDatabaseMetaData.getProcedures( catalog, schemaPattern, procedureNamePattern ) );
  }
  ...
  public ResultSet getProcedureColumns( String catalog, String schemaPattern, String procedureNamePattern, String columnNamePattern ) throws SQLException {
    return new DelegateResultSet(
      realDatabaseMetaData.getProcedureColumns( catalog, schemaPattern, procedureNamePattern, columnNamePattern ) );
  }
   ...
   *                         returned from {@link ${symbol_pound}getTableTypes},to include; <code>null</code> returns
   *                         all types
  ...
  public ResultSet getTables( String catalog, String schemaPattern, String tableNamePattern, String[] types ) throws SQLException {
    return new DelegateResultSet(
      realDatabaseMetaData.getTables( catalog, schemaPattern, tableNamePattern, types ) );
  }
  ...
  public ResultSet getCatalogs() throws SQLException {
    return new DelegateResultSet( realDatabaseMetaData.getCatalogs() );
  }
  ...
  public ResultSet getTableTypes() throws SQLException {
    return new DelegateResultSet( realDatabaseMetaData.getTableTypes() );
  }
  ...
  public ResultSet getColumns( String catalog, String schemaPattern, String tableNamePattern, String columnNamePattern ) throws SQLException {
    return new DelegateResultSet(
      realDatabaseMetaData.getColumns( catalog, schemaPattern, tableNamePattern, columnNamePattern ) );
  }
  ...
  public ResultSet getColumnPrivileges( String catalog, String schema, String table, String columnNamePattern ) throws SQLException {
    return new DelegateResultSet(
      realDatabaseMetaData.getColumnPrivileges( catalog, schema, table, columnNamePattern ) );
  }
  ...
  public ResultSet getTablePrivileges( String catalog, String schemaPattern, String tableNamePattern ) throws SQLException {
    return new DelegateResultSet(
      realDatabaseMetaData.getTablePrivileges( catalog, schemaPattern, tableNamePattern ) );
  }
  ...
  public ResultSet getBestRowIdentifier( String catalog, String schema, String table, int scope, boolean nullable ) throws SQLException {
    return new DelegateResultSet(
      realDatabaseMetaData.getBestRowIdentifier( catalog, schema, table, scope, nullable ) );
  }
  ...
  public ResultSet getVersionColumns( String catalog, String schema, String table ) throws SQLException {
    return new DelegateResultSet(
      realDatabaseMetaData.getVersionColumns( catalog, schema, table ) );
  }
  ...
  public ResultSet getPrimaryKeys( String catalog, String schema, String table ) throws SQLException {
    return new DelegateResultSet( realDatabaseMetaData.getPrimaryKeys( catalog, schema, table ) );
  }
   ...
   * @return <code>ResultSet</code> - each row is a primary key column description
   * @throws SQLException if a database access error occurs
   * @see ${symbol_pound}getExportedKeys
   */
  @Override
  public ResultSet getImportedKeys( String catalog, String schema, String table ) throws SQLException {
    return new DelegateResultSet( realDatabaseMetaData.getImportedKeys( catalog, schema, table ) );
  }
   ...
   * @throws SQLException if a database access error occurs
   * @see ${symbol_pound}getImportedKeys
   */
  @Override
  public ResultSet getExportedKeys( String catalog, String schema, String table ) throws SQLException {
    return new DelegateResultSet( realDatabaseMetaData.getExportedKeys( catalog, schema, table ) );
  }
  ...
  public ResultSet getCrossReference( String parentCatalog, String parentSchema, String parentTable, String foreignCatalog, String foreignSchema, String foreignTable ) throws SQLException {
    return new DelegateResultSet(
      realDatabaseMetaData.getCrossReference( parentCatalog, parentSchema, parentTable,
  ...
  public ResultSet getTypeInfo() throws SQLException {
    return new DelegateResultSet( realDatabaseMetaData.getTypeInfo() );
  }
  ...
  public ResultSet getIndexInfo( String catalog, String schema, String table, boolean unique, boolean approximate ) throws SQLException {
    return new DelegateResultSet(
      realDatabaseMetaData.getIndexInfo( catalog, schema, table, unique, approximate ) );
  }
  ...
  public ResultSet getUDTs( String catalog, String schemaPattern, String typeNamePattern, int[] types ) throws SQLException {
    return new DelegateResultSet(
      realDatabaseMetaData.getUDTs( catalog, schemaPattern, typeNamePattern, types ) );
  }
  ...
  public Connection getConnection() throws SQLException {
    return new DelegateConnection( realDatabaseMetaData.getConnection() );
  }
  ...
  public ResultSet getAttributes( String catalog, String schemaPattern, String typeNamePattern, String attributeNamePattern ) throws SQLException {
    return new DelegateResultSet( realDatabaseMetaData.getAttributes( catalog, schemaPattern, typeNamePattern, attributeNamePattern ) );
  }
  ...
  public ResultSet getSchemas( String catalog, String schemaPattern ) throws SQLException {
    return new DelegateResultSet( realDatabaseMetaData.getSchemas( catalog, schemaPattern ) );
  }
  ...
  public ResultSet getClientInfoProperties() throws SQLException {
    return new DelegateResultSet( realDatabaseMetaData.getClientInfoProperties() );
  }
  ...
  public ResultSet getFunctions( String catalog, String schemaPattern, String functionNamePattern ) throws SQLException {
    return new DelegateResultSet(
      realDatabaseMetaData.getFunctions( catalog, schemaPattern, functionNamePattern ) );
  }
  ...
  public ResultSet getFunctionColumns( String catalog, String schemaPattern, String functionNamePattern, String columnNamePattern ) throws SQLException {
    return new DelegateResultSet(
      realDatabaseMetaData.getFunctionColumns( catalog, schemaPattern, functionNamePattern, columnNamePattern ) );
  }
   ...
   * value returned will correspond to the enum name returned by {@link PseudoColumnUsage${symbol_pound}name PseudoColumnUsage.name()}
   * <LI><B>REMARKS</B> String => comment describing column (may be <code>null</code>)
   * <LI><B>CHAR_OCTET_LENGTH</B> int => for char types the
   * maximum number of bytes in the column
   * <LI><B>IS_NULLABLE</B> String  => ISO rules are used to determine the nullability for a column.
  ...
  public ResultSet getPseudoColumns( String catalog, String schemaPattern, String tableNamePattern, String columnNamePattern ) throws SQLException {
    return new DelegateResultSet(
      realDatabaseMetaData.getPseudoColumns( catalog, schemaPattern, tableNamePattern, columnNamePattern ) );
  }
