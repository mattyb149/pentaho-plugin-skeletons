...
package org.pentaho.di.trans.steps.mytrans;
...
public class MyTrans extends BaseStep implements StepInterface
{
	...
	public MyTrans(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, TransMeta transMeta, Trans trans)
	{
